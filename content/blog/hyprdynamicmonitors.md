...
keywords:
  [
    ...
    "hyprdynamicmonitors",
    "Hyprland monitor setup automatic",
    "Hyprland external monitor auto switch",
    "Hyprland autorandr alternative",
    "Hyprland external monitor auto detect",
    ...
    "hyprland dpi scaling monitors",
    "hyprland monitor power management",
    "hyprland monitor sleep on battery",
    "hyprland monitor setup script",
    "hyprland monitor hotplug",
    "hyprland monitor detection issues",
    "hyprland monitor auto-detect external display",
    "hyprland monitor configuration command",
    "hyprland monitor setup tool",
    "hyprland configure multiple monitors",
    "hyprland multiple displays",
    "hyprland dock external monitor",
    "hyprland thunderbolt display",
    "hyprland laptop lid close external monitor",
    "hyprland auto switch monitor profile",
    "hyprland monitor profile manager",
    "hyprland multi-display tool",
    "hyprland external monitor lag",
    "hyprland monitor resolution change",
    "hyprland screen tearing",
    "hyprland display scaling config",
    "hyprland refresh rate per display",
    "hyprland monitor configuration tips",
    "hyprland monitor layout manager",
    "hyprland save monitor layout",
    "hyprland reload monitor layout",
    "hyprland power-aware monitor manager",
    "hyprland battery refresh rate switching",
    "hyprland dock undock monitor issue",
    "hyprland laptop external monitor setup",
    "hyprland autorandr replacement",
    "hyprland kanshi alternative",
    "hyprland display profile manager",
    "hyprland monitor auto arrange",
    "hyprland wayland display management",
    "hyprland detect displays automatically",
    "hyprland monitor config reload",
    "hyprland screen configuration utility",
    "hyprland multi monitor script",
  ]
---
